...
const Experience = () => {
  ...
  return (
    <Admindashboard>
        ...
        <div className={`${addExp?'absolute block':'hidden'} w-[90%] max-w-[600px] absolute left-[50%] translate-x-[-50%] z-40 bg-gray-200 p-5`}><Card><AddExperience  cancel={setAddExp}/></Card></div>
        </div>
    </Admindashboard>
  )
}
